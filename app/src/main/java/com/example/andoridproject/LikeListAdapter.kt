...
class LikeListAdapter(val myitemLists: ArrayList<SalesPost>) : RecyclerView.Adapter<LikeListAdapter.ViewHolder>() {
    private val storage: FirebaseStorage by lazy {
        FirebaseStorage.getInstance()
    }

    interface OnItemClickListeners {
        fun onItemClick(view: LikelistItemBinding, salesPost: SalesPost, position: Int)
    }
    ...
    inner class ViewHolder(private val binding: LikelistItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = LikelistItemBinding.inflate(
